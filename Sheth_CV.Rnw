...
Preston, J. C, \underline{R. Wooliver\textsuperscript{p}}, H. Driscoll, E. Coughlin, and \textbf{S. N. Sheth}. Spatial variation in high temperature-regulated gene expression predicts evolution of plasticity with climate change in the scarlet monkeyflower. In review at \emph{Molecular Ecology}. \tabularnewline
