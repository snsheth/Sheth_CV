...
\begin{enumerate}
\reverselabel{20} %set to total # of publications

\item \textbf{Sheth, S.N.}, N. Morueta-Holme, and A. L. Angert. Determinants of geographic range size in plants. In press, \emph{New Phytologist}. https://doi.org/10.1111/nph.16406.
...
%\subsection*{\textit{In review} or \textit{In revision}}
%\begin{hangparas}{.5in}{1}

%Wooliver, R., S.B. Tittes, \textbf{S.N. Sheth}. A resurrection study reveals rapid evolution of thermal performance in a leading range edge population in response to recent climate change. In review, \emph{Ecology Letters}.
...
\addtolength{\leftskip}{5ex}\emph{Dissertation Research: Role of evolutionary potential in limiting distributions} (co-PI)
...
\hangindent=5ex Hamilton student award committee member, Society for the Study of Evolution & 2020 - present \tabularnewline
...
\hangindent=5ex Intro to Python for ArcGIS Workshop, Colorado State University, Fort Collins, CO & 2016 \tabularnewline
